									...
									<tr>
										<td>
											<div class="form-group" style="margin-top: 6px;">
												...
												<div class="col-xs-6">
													<a href="/sales/product" class="btn btn-info btn-sm" style="outline:none; background: rgb(209, 91, 71) !important; border: 0px !important; margin-top: 0px; width: 100%; padding: 7px 5px; font-weight: bold; outline: none; border-radius: 5px;">Reset</a>
												</div>
											</div>
										</td>
									</tr>
	...
	new Vue({
		...
		methods: {
			...
			holdSale() {
				...
				axios.post('/hold_sale', data).then(res => {
					let r = res.data;
					if (r.success) {
						alert(r.message);
				...
				await axios.post('/get_hold_sale', {
					...
					r.saleDetails.forEach(product => {
						let cartProduct = {
							...
							type: product.is_package != 0 ? 'package' : 'product'
						}
