...
<div id="salesRecord">
		...
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				...
				<div class="form-group" v-bind:style="{display: searchTypesForRecord.includes(searchType) ? '' : 'none'}">
					...
					<select class="form-control" v-model="recordType" @change="sales = [];getSearchResult()">
	...
	<div v-if="sales.length == 0" style="margin-top:15px;text-align:center;" v-bind:style="{display: sales.length == 0 ? '' : 'none'}">
