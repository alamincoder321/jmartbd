		...
		<div class="form-horizontal">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					...
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input type="number" step="any" min="0" id="salary_range" name="salary_range" value="<?php echo $selected->salary_range; ?>" placeholder="Salary Range .." class="form-control" />
				...
				<div class="form-group">
					...
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input type="number" step="any" min="0" id="tada" name="tada" value="<?php echo $selected->tada; ?>" placeholder="TA/DA" class="form-control" />
						<div id="tada_" class="col-sm-12"></div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input type="number" step="any" min="0" id="other" name="other" value="<?php echo $selected->other; ?>" placeholder="Insentive/Others" class="form-control" />
						<div id="other_" class="col-sm-12"></div>
					</div>
				</div>
