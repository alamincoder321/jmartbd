...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="VehicleManagement" class="group-head" @click="onClickGroupHeads"> <strong>Vehicle Management</strong>
                <ul ref="VehicleManagement">
                    <li><input type="checkbox" class="access" value="vehicle" v-model="access"> Vehicle Entry</li>
                    <li><input type="checkbox" class="access" value="vehicleList" v-model="access"> Vehicle List</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
