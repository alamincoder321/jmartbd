...
<div class="col-xs-12">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label no-padding-right">:</label>
			<div class="col-sm-3">
				<input type="text" id="subcatname" name="subcatname" placeholder="Sub Category Name" value="<?php echo set_value('subcatname'); ?>" class="form-control" />
				<span id="msg"></span>
				<?php echo form_error('subcatname'); ?>
				<span style="color:red;font-size:15px;">
			</div>
		</div>
...
<script type="text/javascript">
    function submit(){
        ...
        var inputdata = 'catname='+catname+'&catdescrip='+catdescrip+'&subcatname='+subcatname;
        var urldata = "<?php echo base_url();?>insertsubcategory";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
