...
<div class="row" id="purchaseReturn">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<form class="form-inline" id="searchForm">
			<div class="form-group" style="display:none;" v-bind:style="{display: suppliers.length > 0 ? '' : 'none'}">
				<label>Supplier</label>
				<v-select v-bind:options="suppliers" label="display_name" v-model="selectedSupplier" v-on:input="getInvoices" v-bind:disabled="purchaseReturn.returnId == 0 ? false : true"></v-select>
			</div>
			...
			<div class="form-group">
				<button type="button" class="btn btn-info btn-xs" style="width: 100px;" @click="getPurchaseDetailsForReturn" v-bind:disabled="purchaseReturn.returnId == 0 ? false : true">View</button>
			</div>
		</form>
	</div>
	...
	new Vue({
		...
		methods: {
			...
			getInvoices() {
				...
				axios.post('/get_purchases', arg).then(res => {
