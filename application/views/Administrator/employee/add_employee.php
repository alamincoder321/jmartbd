		...
		<div class="form-horizontal">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					...
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input type="number" step="any" min="0" autocomplete="off" id="salary_range" name="salary_range" value="<?php echo set_value('phone_number'); ?>" placeholder="Salary Range .." class="form-control" />
						<div id="salary_range_" class="col-sm-12"></div>
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-4 control-label" for="tada">TA/DA</label>
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input type="number" step="any" min="0" id="tada" name="tada" value="<?php echo set_value('tada'); ?>" placeholder="TA/DA" class="form-control" />
						<div id="tada" class="col-sm-12"></div>
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-4 control-label" for="other">Insentive/Others</label>
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input type="number" step="any" min="0" id="other" name="other" value="<?php echo set_value('other'); ?>" placeholder="Insentive/Others" class="form-control" />
						<div id="other" class="col-sm-12"></div>
					</div>
				</div>
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label"> Employee Image </label>
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
