	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			<div class="form-group">
				...
				<div class="col-md-2">
					<input type="text" class="form-control" id="invoice" name="invoice" v-model="purchase.invoice" readonly style="height:26px;" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input type="text" class="form-control" id="added_by" name="added_by" value="<?php echo $this->session->userdata('FullName'); ?>" readonly style="height:26px;" />
				</div>
			</div>
	...
	<div class="col-xs-12 col-md-9 col-lg-9">
		<div class="widget-box">
			<div class="widget-header">
				<h4 class="widget-title">International Bill Information</h4>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="col-xs-1" style="padding: 0;">
									<a href="<?= base_url('international_supplier') ?>" title="Add New Supplier" class="btn btn-xs btn-danger" style="height: 25px; border: 0; width: 27px; margin-left: -10px;" target="_blank"><i class="fa fa-plus" aria-hidden="true" style="margin-top: 5px;"></i></a>
								</div>
							</div>
...
<script>
	...
	new Vue({
		...
		methods: {
			...
			async getSuppliers() {
				await axios.get('/get_international_suppliers').then(res => {
			...
			savePurchase() {
				...
				let url = '/add_international_purchase';
				if (this.purchase.purchaseId != 0) {
					url = '/update_international_purchase';
				}
				...
				axios.post(url, data).then(async res => {
					...
					if (r.success) {
						...
						if (conf) {
							...
							window.location = '/international_purchase';
						} else {
							window.location = '/international_purchase';
						}
					} else {
			...
			async getPurchase() {
				await axios.post('/get_international_purchases', {
