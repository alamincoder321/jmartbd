				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" min="0" step="any" class="form-control" v-model="payment.CPayment_amount">
							</div>
						</div>
	...
	new Vue({
		...
		methods: {
			getCustomerPayments() {
				...
				axios.post('/get_international_customer_payments', data).then(res => {
			...
			saveCustomerPayment() {
				...
				let url = '/add_international_customer_payment';
				if (this.payment.CPayment_id != 0) {
					url = '/update_international_customer_payment';
				}
			...
			editPayment(payment) {
				...
				this.selectedCustomer = this.customers.find(c => c.Customer_SlNo == payment.CPayment_customerID);
			...
			deletePayment(paymentId) {
				...
				axios.post('/delete_international_customer_payment', {
					paymentId: paymentId
				}).then(res => {
					let r = res.data;
					alert(r.message);
